...
export default function AddCategory({ visible, onClose, onSubmit }) {
        ...
        <Modal visible={visible} animationType="fade" transparent={true}>
            <View style={styles.container}>
                <View style={styles.dialog}>
                    <Text style={{ fontFamily: 'Inter-Medium' }} className="text-black text-center text-2xl py-2">Thêm mới thể loại</Text>
